export const Icons = {
  ...
  github: {
    paths: [
      {
        d: "M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12",
      },
    ],
    class:
  ...
  invoice: {
    paths: [{d: "M15.999 2.5h-12a1.5 1.5 0 0 0-1.5 1.5v12a1.5 1.5 0 0 0 1.5 1.5h12a1.5 1.5 0 0 0 1.5-1.5v-12a1.5 1.5 0 0 0-1.5-1.5Zm-1.5 9h-9a.5.5 0 0 1 0-1h9a.5.5 0 0 1 0 1Zm0-4h-9a.5.5 0 0 1 0-1h9a.5.5 0 0 1 0 1Zm-3.5 8h-2a.5.5 0 0 1 0-1h2a.5.5 0 0 1 0 1Z"}]
  },
  play: {
    paths: [
      {
  ...
  collect: {
    paths: [{d: "M17.5 7.5a.5.5 0 0 0-.5-.5h-14a.5.5 0 0 0 0 1h14a.5.5 0 0 0 .5-.5Zm-15-2a.5.5 0 0 0 0 1h15a.5.5 0 0 0 0-1h-15Zm0 4a.5.5 0 0 0 0 1h15a.5.5 0 0 0 0-1h-15Z"}]
  },
  funds: {
    paths: [{d: "M13.5 2.5a.5.5 0 0 0-.5.5v14a.5.5 0 0 0 1 0v-14a.5.5 0 0 0-.5-.5Zm-5 0a.5.5 0 0 0-.5.5v14a.5.5 0 0 0 1 0v-14a.5.5 0 0 0-.5-.5Zm-5 0a.5.5 0 0 0-.5.5v14a.5.5 0 0 0 1 0v-14a.5.5 0 0 0-.5-.5Z"}]
  },
  auto: {
    paths: [{d: "M10 2a8 8 0 1 0 0 16 8 8 0 0 0 0-16Zm-1.5 5.5a.5.5 0 0 1 1 0v3.086l2.71 1.626a.5.5 0 0 1-.52 1.576l-3-1.8a.5.5 0 0 1-.19-.412V7.5Z"}]
  },
  pricing: {
    paths: [{d: "m13.758 5.603-2-2.5a.5.5 0 0 0-.816.594l1.49 1.863-4.135 4.135a.5.5 0 0 0 0 .707l.354.354a.5.5 0 0 0 .707 0l4.135-4.135 1.863 1.49a.5.5 0 0 0 .816-.594l-2.5-2Z"}]
  },
  gateways: {
    paths: [{d: "M3.5 2.5a.5.5 0 0 0-.5.5v14a.5.5 0 0 0 1 0v-6h12v6a.5.5 0 0 0 1 0v-14a.5.5 0 0 0-1 0v6h-12v-6a.5.5 0 0 0-.5-.5Z"}]
  },
  portal: {
    paths: [{d: "M11.5 2.5a.5.5 0 0 0-.5.5v3h-8v-3a.5.5 0 0 0-1 0v3a.5.5 0 0 0 .5.5H11v1h-1a.5.5 0 0 0-.5.5v6a.5.5 0 0 0 1 0v-2.5h8v2.5a.5.5 0 0 0 1 0v-6a.5.5 0 0 0-.5-.5H12v-1h1a.5.5 0 0 0 .5-.5v-3a.5.5 0 0 0-1 0v3h-1v-3a.5.5 0 0 0-.5-.5Z"}]
  },
  terminal: {
    paths: [{d: "M3.5 2.5a.5.5 0 0 0-.5.5v14a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-14a.5.5 0 0 0-.5-.5h-13ZM4 11.5a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5Z"}]
  },
  offline: {
    paths: [{d: "M12.293 2.293a1 1 0 0 1 1.414 0l4 4a1 1 0 0 1 0 1.414l-8 8a1 1 0 0 1-1.414 0l-8-8a1 1 0 0 1 0-1.414l4-4a1 1 0 0 1 1.414 0L10 6.586l2.293-2.293Z"}]
  },
};
